...
namespace {
    class Eloquent
    {
        ...
        {
            return self::$root->findOrFail($id, $columns);
        }
        ...
        {
            return self::$root->touches($relation);
        }
        ...
        {
            return self::$root->getQualifiedKeyName();
        }
        ...
        {
            self::$root->setUnguardState($state);
        }
        ...
        {
            return self::$root->isGuarded($key);
        }
        ...
        {
            return self::$root->totallyGuarded();
        }
        ...
        {
            return self::$root->getTouchedRelations();
        }
        ...
        {
            self::$root->setTouchedRelations($touches);
        }
...
namespace {
    class Form
    {
        ...
        {
            self::$root->__construct($html, $url, $csrfToken);
        }
        ...
        {
            return self::$root->setSessionStore($session);
        }
...
namespace {
    class Html
    {
        ...
        {
            return self::$root->image($url, $alt, $attributes);
        }
        ...
        {
            return self::$root->link($url, $title, $attributes, $secure);
        }
        ...
        {
            return self::$root->secureLink($url, $title, $attributes);
        }
        ...
        {
            return self::$root->linkAsset($url, $title, $attributes, $secure);
        }
        ...
        {
            return self::$root->linkSecureAsset($url, $title, $attributes);
        }
        ...
        {
            return self::$root->linkRoute($name, $title, $parameters, $attributes);
        }
        ...
        {
            return self::$root->linkAction($action, $title, $parameters, $attributes);
        }
...
namespace {
    class Paginator
    {
        ...
        {
            self::$root->__construct($request, $view, $trans, $pageName);
        }
        ...
        {
            self::$root->setPageName($pageName);
        }
...
namespace {
    class Response
    {
        ...
        {
            return self::$root->download($file, $name, $headers);
        }
...
namespace {
    class Route
    {
        ...
        {
            return self::$root->currentRouteName();
        }
        ...
        {
            return self::$root->currentRouteAction();
        }
...
namespace {
    ...
    {
        /**
         * @var \Illuminate\Session\ArrayStore $root
         */
        static private $root;
